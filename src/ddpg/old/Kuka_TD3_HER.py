...
class KukaTD3HERAgent:
    def __init__(self, state_size, action_size,
        ...
        self.critic_one = HERCritic(self.state_size, self.action_size, self.replacement,
                                    self.critic_lr, self.gamma, self.feature)
        self.critic_two = HERCritic(self.state_size, self.action_size, self.replacement,
                                    self.critic_lr, self.gamma, self.feature)
    ...
    def experience_replay(self):
        ...
        if self.train_step % self.policy_decay == 0:
            actor_loss = self.actor.train(s_batch, g_batch, self.critic_one)
