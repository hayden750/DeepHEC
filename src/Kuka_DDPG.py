''' DDPG Implementation with Actor-Critic '''
...
class KukaDDPGAgent:
    def __init__(self, state_size, action_size,
        ...
        self.actor = DDPGActor(self.state_size, self.action_size, self.replacement,
                               self.actor_lr, self.upper_bound, self.feature)

        self.critic = DDPGCritic(self.state_size, self.action_size, self.replacement,
    ...
    def experience_replay(self):
        ...
        # Update Actor (Policy)
        actor_loss = self.actor.train(s_batch, self.critic)
